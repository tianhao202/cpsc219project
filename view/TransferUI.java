		...
		transferButton.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
				...
				if(user.getCardPassword().equals(passwordField1.getText())){
					...
					user.setYue(String.valueOf(Integer.valueOf(user.getBalance())-Integer.valueOf(txtField1.getText())));
					userdao.update(user);
					user zzuser=zzlist.get(0);
					zzuser.setYue(String.valueOf(Integer.valueOf(zzuser.getBalance())+Integer.valueOf(txtField1.getText())));
