	...
	public DrawUI(String param) {
		...
		button7.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
				user user1 = userdao.queryByKey("userming", param).get(0);
				if(txtField1.getText().equals("")){
					showMsg("enter withdraw amount");
					return;
				}
				if(user1.getCardPassword().equals(passwordField1.getText())){
					if(Integer.valueOf(user1.getYue())<Integer.valueOf(txtField1.getText())){
						showMsg("Insufficient balance");
						return;
					}
					user1.setBalance(String.valueOf(Integer.valueOf(user1.getYue())-Integer.valueOf(txtField1.getText())));
