...
public class userUpdateUI extends AnchorPane {
	...
	public userUpdateUI(String param) {
		this.mainid=param;
		...
		this.setTopAnchor(txtField2, Double.valueOf(120));
		...
		this.setTopAnchor(txtField3, Double.valueOf(180));
		...
		this.setTopAnchor(txtField4, Double.valueOf(240));
		...
		this.setTopAnchor(txtField5, Double.valueOf(120));
		...
		this.setLeftAnchor(txtField6, Double.valueOf(220));
		...
		this.setLeftAnchor(txtField7, Double.valueOf(220));
		this.setTopAnchor(txtField7, Double.valueOf(60));
		...
		*/
		saveButton.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
		 			user bean = userL.get(Integer.valueOf(param));
				bean.setUsername(txtField7.getText());
				bean.setPassword(txtField1.getText());
				bean.setName(txtField5.getText());
				bean.setAge(txtField2.getText());
				bean.setGender(comboBox1.getSelectionModel().getSelectedItem());
				bean.setCardNumber(txtField3.getText());
				bean.setCardPassword(txtField6.getText());
				bean.setBalance(txtField4.getText());
				user1.update(bean);
				showMsg("success");
			}
		});
		...
		tableView1.setOnMouseClicked(new EventHandler<Event>() {
			public void handle(Event event) {
				...
				txtField7.setText(bean.getUsername());
				txtField1.setText(bean.getPassword());
				txtField5.setText(bean.getName());
				txtField2.setText(bean.getAge());
				comboBox1.setValue(bean.getGender());
				txtField3.setText(bean.getCardNumber());
				txtField6.setText(bean.getCardPassword());
				txtField4.setText(bean.getBalance());
