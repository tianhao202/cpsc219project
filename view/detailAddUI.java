...
public class detailAddUI extends AnchorPane {
	...
	public detailAddUI(String param) {
		this.mainid=param;
		...
		this.setTopAnchor(txtField1, Double.valueOf(120));
		...
		saveButton.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
				...
				bean.setTime(txtField2.getText());
				bean.setAmount(txtField4.getText());
				bean.setUser(txtField1.getText());
				bean.setNote(txtField3.getText());
				detail1.add(bean);
				showMsg("success");
				detailLRefresh();
		...
		tableView1.setOnMouseClicked(new EventHandler<Event>() {
			public void handle(Event event) {
				...
				txtField2.setText(bean.getTime());
				txtField4.setText(bean.getAmount());
				txtField1.setText(bean.getuser());
				txtField3.setText(bean.getNote());
