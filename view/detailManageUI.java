...
public class detailManageUI extends AnchorPane {
	...
	public detailManageUI(String param) {
		this.mainid=param;
		...
		this.setLeftAnchor(txtField3, Double.valueOf(660));
		...
		*/
		editButton.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
			    ...
			    stage.setTitle("edit");
			    stage.setScene(new Scene(new detailUpdateUI(String.valueOf(row)),600,600));
			    stage.show();
			}
		});
		...
		addButton.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
			    Stage stage=new Stage();
			    stage.setTitle("add");
			    stage.setScene(new Scene(new detailAddUI(""),600,600));
			    stage.show();
			}
		});
		...
		deleteButton.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
				...
				detail1.delBykey("id", bean.getId().toString());
				showMsg("success");
				detailLRefresh();
		...
		searchButton.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
				...
				bean.setUser(txtField2.getText());
		...
		tableView1.setOnMouseClicked(new EventHandler<Event>() {
			public void handle(Event event) {
				...
				txtField2.setText(bean.getuser());
